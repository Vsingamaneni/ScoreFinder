                    ...
                    <form action="/registerUser" modelAttribute="registerForm" method="POST" class='form-horizontal' role='form'>
                        ...
                        <div class='form-group'>
                            ...
                            <div class='col-md-6'>
                                <div class='form-group'>
                                    <div class='col-md-11'>
                                        <input class='form-control' id='id_security' placeholder='Admin Security Code' name="security" type='password'>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class='form-group'>
                            <label class='control-label col-md-2 col-md-offset-2' for='id_terms'>Terms & Conditions</label>
                        <div class='col-md-8'>
